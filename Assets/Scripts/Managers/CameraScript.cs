...
public class CameraScript : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        bus = FindObjectOfType<PlayerBusScript>().gameObject;
    }
    private void Start()
    {
        ScrollInput();
    ...
    private void Update()
    {
        transform.position = new Vector3(bus.transform.position.x, transform.position.y, bus.transform.position.z -4);
    }
